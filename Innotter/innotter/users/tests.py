...
class MainTests(APITestCase):
    ...
    def setUp(self):
        ...
        CustomUser.objects.create_superuser(email='slavakah1@gmail.com',
                                            username='ADMINUSER',
                                            password='slava1234',
                                            first_name='SLava',
                                            last_name='Kulak')
    ...
    def test_user_registration(self):
        response = self.client.post(self.registerurl,
                                    {'email': 'slavakah2@gmail.com',
                                     'password': 'slava1234',
                                     'username': 'test1user',
                                     'first_name': 'SLava',
                                     'last_name': 'Kulak'}, format='json')
    ...
    def test_user_filter(self):
        ...
        headers = {'Authorization': f'Token {access_token}'}
        self.client.credentials(**headers)
        CustomUser.objects.create_superuser(email='slavakah2@gmail.com',
                                            password='slava1234',
                                            first_name='SLava',
                                            last_name='Kulak',
                                            username='Abudabi')

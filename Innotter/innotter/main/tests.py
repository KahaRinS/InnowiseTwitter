...
from main.models import Page, Tag
...
class MainTests(APITestCase):
    ...
    def setUp(self):
        ...
        user = CustomUser.objects.create_superuser(email='slavakah1@gmail.com',
                                                   password='slava1234',
                                                   first_name='SLava',
                                                   last_name='Kulak',
                                                   username='Admin')
        testpage = Page.objects.create(name='TestPage',
                                       description='just description for test page',
                                       owner=user)
    ...
    def test_page_create_with_bad_data(self):
        CustomUser.objects.create_user(email='test2@gmail.com',
                                       password='slava1234',
                                       first_name='Test',
                                       last_name='Test')
        access_token = self.client.post(self.loginurl,
    ...
    def test_page_name_filter(self):
        user = CustomUser.objects.create_superuser(email='slavakah2@gmail.com',
                                                   password='slava1234',
                                                   first_name='SLava',
                                                   last_name='Kulak',
                                                   username='SecondAdmin')
        Page.objects.create(name='Test1Page',
                            description='just description for test page',
                            owner=user)
    ...
    def test_page_tags_filter(self):
        ...
        page = Page.objects.create(name='Test1Page',
                                   description='just description for test page',
                                   owner=user)
        page.tags.add(tag)
